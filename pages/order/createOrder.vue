	...
	<view>
		...
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				...
				<view class="cen">
					<view class="top">
						<text class="name">{{addressData.consigner}}</text>
						<text class="mobile">{{addressData.mobile}}</text>
					</view>
					<text class="address">{{addressData.address_info}} {{addressData.address}}</text>
				</view>
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">自购优惠</text>
...
<script>
	...
	export default {
		...
		methods: {
			getData(){
				let opts={ url: contactInterface.addressList, method: 'get'};
				http.httpRequest(opts, {uid:this.userInfo.uid}).then(res => {
