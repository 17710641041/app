									...
									<view 
										...
										>
											...
											<view class="pic" v-show="index===base_items.current">
												<image src="../../static/address/yes.png"></image>
											</view>
									</view>
								</scroll-view>
							</view>
...
<script>
	import linkAddress_p from '../../static/address/get_linkAddress_p.js'
	export default{
		data(){
			return{
				newActive:"",
		...
		methods: {
			...
			province_txt_click(target){
				...
				//再赋值
				this.submission.province_id=target;
				this.selected_address=this.user_address.province_id;
				
				this.user_address.province=province;
				this.user_address.province_id=target;
				//请求市数据
			...
			city_txt_click(target){
				...
				this.user_address.city_id=target;
				//把区的信息置为空
				this.user_address.district='';
				
				this.submission.city_id=target;
			...
			district_txt_click(target){
				...
				this.user_address.district_id=target;
